"""Regression checks for the amber-gfx-shader-lab casebook."""
...
from casebook.harness import assert_expected, amber_gfx_shader_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_gfx_shader_lab_summary(), assert_expected())
